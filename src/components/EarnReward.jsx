        ...
        <div className='container-earn  md:mt-[60px] mt-[40px] md:mb-[60px] mb-[40px]'>
            <div className="bg-[url('/images/facelift/bg-reward-section.webp')] bg-cover bg-center flex  gap-[6%] reward-section   py-[70px] md:rounded-[8px]">
                <div className='flex flex-col  shop-earn-redeem '>
                    <div className='flex gap-[14px] mb-[35px] shop-earn  font-opensans'>
                    ...
                    <div>
                        <h2 className='text-[21px]  uppercase font-semibold leading-[1.9047619048] my-[-2px] font-montserrat'>Earn Reward Points</h2>
                        <p className='text-[18px] mb-[10px]   leading-[1.3888888889] text-wrap font-opensans'  > Create an account and earn points for every purchase and referral order. Use points as cash towards future purchases!</p>
                    </div>
                </div>
                <div className='flex md:flex-col flex-row items-center gap-3  join-reward-program font-montserrat' >

                    <div className="border-[2px] border-black hover:shadow-[0_0_0_2px_black] box-border transition-all duration-300 ease-in-out gap-4 items-center rounded-[16px] join-wrapper py-[15px] w-full">
                    ...
                    <hr className="md:block hidden  my-4 h-[3px] w-full bg-black  " />

                    <div className='border-[2px] border-black hover:shadow-[0_0_0_2px_black] box-border transition-all duration-300 ease-in-out gap-4 items-center rounded-[16px] join-wrapper py-[15px] w-full'>
                        <Link href="#" className='flex md:flex-row flex-col gap-4 rounded-[16px] items-center'>
                            <Image src="/images/facelift/ico-n-reward-2.webp" alt='error' width={68} height={68} />
                            <div className='flex flex-col text-center'>
                                <h3 className='md:text-[21.0001px] text-[14.8236px] leading-[1.4285714286] font-bold mb-[3px] text-wrap'>
                                    Join Rewards Program
                                </h3>
                                <p className='md:text-[17px] text-[12px] leading-[1.4117647059] text-wrap font-normal '>
                                    <strong>Earn points</strong> for <u>every person you refer to STL</u>
                                </p>
                            </div>
                        </Link>
                    </div>
