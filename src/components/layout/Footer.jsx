...
const Footer = () => {
  return (
    ...
    <footer className=" border-t font-mont pt-[43px] font-montserrat">
  ...
  transition w-[102px] hover:bg-[rgb(153.4638297872,30.5361702128,43.8468085106)] cursor-pointer ">
      ...
      <div className=" w-full pt-[21px] pb-[61px]  md:flex md:items-center md:justify-between">
        <div className='flex  flex-col md:flex-row container    transition:all ease .3s md:justify-between justify-center items-center'>
          ...
          <div className="flex  text-white text-[14px] leading-[1.2857142857] space-x-[26px]">
