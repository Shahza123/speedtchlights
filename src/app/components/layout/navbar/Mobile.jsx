...
const Mobile = () => {
 ...
 useEffect(() => {
  ...
  return () => (document.body.style.overflow = "auto");
    ...
    return (
        <>
            <div className='flex justify-center bg-[#ebecec]   w-full     items-center'>
                <div className="flex justify-between   2xl:max-w-[1523px]  xl:max-w-[1160px]  lg:max-w-[960px]  md:max-w-[740px]  sm:max-w-[425px]    w-full     items-center   px-[10px] py-[5px]">
