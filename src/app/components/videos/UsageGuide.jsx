...
const UsageGuide = () => {
    return (
        <>
            <div className="w-full h-full bg-[url('/images/facelift/bg-n-videos-section-2.webp')] bg-cover bg-center bg-no-repeat md:py-[43px] py-[26px] font-mont">
                <div className='container text-black  h-full'>
                    <h3 className='text-center md:mb-[21.5px] mb-[13px] font-medium text-[24px]  leading-[1.4166666667] font-mont'>VIDEOS: HOW IT WORKS</h3>
                    ...
                    <div className='grid   xs:grid-cols-1  grid-cols-2 video-guide-gap md:gap-[40px] gap-[20px]  min-h-[1px]  place-items-center  md:px-[20px]'>
                        ...
                        <div className='flex flex-col  h-full text-wrap text-center   demo-second-video'>
                            ...
                            <div className='usage-demo'>
                                <p className='text-black font-mont md:text-[15px] text-[12px] leading-[1.3333333333] font-normal text-center mt-[24px]'>Customize your light bar to your needs using our online Customization Tool.</p>
                            </div>
